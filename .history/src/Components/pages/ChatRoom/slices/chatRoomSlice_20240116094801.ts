...
export const postChatRoomList = createAsyncThunk('chatRoom/postChatRoomList', async (devicekey: string) => {
    const data = {
        'devicekey': devicekey,
        'force': 'Y',
    };
...
export const postChatList = createAsyncThunk('chatRoom/postChatList', async (devicekey: string) => {
    const data = {
        'devicekey': devicekey,
        'force': 'Y',
    };
